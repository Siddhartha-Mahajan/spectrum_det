...
- If this work continues later, next step should be dynamic witness-path instrumentation for the six remaining missing order-13 high-tail values in the patched long-run snapshot: `2271, 2307, 2316, 2336, 2360, 2916`. The static witness audit shows row/block/lex filters pass, so inspect live `F`, `Gamma`, `e_r`, and bound state along those witness paths.
